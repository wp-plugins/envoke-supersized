...
(function($){
	...
	theme = {
		    ...
		    if (api.options.progress_bar && !vars.is_paused) $(vars.progress_bar).stop().css({left : -$(window).width()});
		  	...
		  	// Update slide caption
		   	if ($(vars.slide_caption).length){
				...
				$(vars.slide_caption).html(api.getField('caption'));
		   	}
		    // Update slide number
	 ...
	 $.supersized.themeVars = {
		...
		image_path			:	ENSS.image_url,				// Default image path
		...
		slide_caption		:	'#slidecaptiontext',	// Slide caption
