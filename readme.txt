...
This plugin creates an easy to use interface for managing the Supersized jQuery Plugin on your site. Supersized is a fullscreen background slideshow built using the jQuery library.
